...
publicCommunitiesRouter.get('/community-config', async (req, res) => {
  ...
  res.json({
    ...
    padelCourtLabel: row.padelCourtLabel?.trim() || null,
    ...
    padelOpenTime2: row.padelOpenTime2,
    padelCloseTime2: row.padelCloseTime2,
    ...
    appNavControlEntradaEnabled: row.appNavControlEntradaEnabled === true,
